...
**Tab 3 – Shape.** Reserved for variable potential shape (rectangular / harmonic / Morse / Coulomb-like). Not yet implemented. The harmonic-vs-Morse contrast is the obvious chemistry candidate (vibrational quanta in a diatomic), but the design is deferred until Tabs 1–2 have been used with students.
